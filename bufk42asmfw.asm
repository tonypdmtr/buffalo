...
RLN0                ldx       #INBUFF
                    abx
                    staa      ,x                  ; initialize input buffer
                    incb
                    cmpb      #BUFFLNG
                    blt       RLN0
; *b=0;
...
REG6                psha
                    ...
                    ldaa      SHFTREG
                    staa      ,x                  ; put in top byte
                    inx
REG7                ldaa      SHFTREG+1
                    staa      ,x                  ; put in bottom byte
REG8                pulx
                    pula
                    ldab      ,x                  ; CHECK FOR REGISTER S
                    cmpb      #'S'
                    beq       REG9                ; jump if "s"
...
LOOP                ldaa      ,y                  ; Loop to xfer command line
...
MSGEVB              fcc       'cat evbtest.out',$0D,$04
